...
public class ReturnResult implements Serializable {
    ...
    private Object data;
    /*** 正常响应 * @return */
    public static ReturnResult ok() { return ok(ErrorCodeEnum.OK); }
    ...
    /*** 异常响应 * @return
     */
    public static ReturnResult error() { return error(ErrorCodeEnum.SYSTEM_EXECUTION_ERROR); }
     ...
     * @param msg 错误信息 * @return */
    public static ReturnResult error(String errorCode, String msg) { return error(false, errorCode, msg); }/*** 异常响应 * @param success 是否成功标示 * @param errorCode 内部错误码 * @param msg 错误信息 * @return */ public static ReturnResult error(Boolean success, String errorCode, String msg) {
         return error(success, errorCode, msg, null);
    }
    /*** 异常响应 * @param success 是否成功标示,成功为true;失败为false,一般情况下为true
     * @param errorCode 内部错误码 * @param msg 错误信息
     * @param data 数据 * @return */
    ...
    private ReturnResult(String success, String errorCode, String msg, Object data) { this.success = success; this.errorCode = errorCode; this.msg = msg; this.data = data; }
